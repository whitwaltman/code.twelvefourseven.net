...
- certbot
---
If you have your DNS stuff configured and your name servers pointing to the correct location, you can start serving web content and obtain an SSL certificate in 8 easy steps.
...
```
3. Reload `httpd`
4. If you have `certbot` installed: `certbot certonly --webroot -w /var/www/new.twelvefourseven.net -d new.twelvefourseven.net`. If not, run `pkg_add certbot` then go back to the start of step 4.
